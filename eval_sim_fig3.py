...
# em containers
em_mc_ave_error = np.zeros((20, 10))
em_process_time = np.zeros_like(opt_mc_ave_error)
em_ave_error_array = []
em_process_time_array = []

# optimization containers
boem_mc_ave_error = np.zeros((20, 10))
boem_process_time = np.zeros_like(opt_mc_ave_error)
...
ax1.plot(time_array[0:6], opt_ave_error_array[0:6], '-x', color = plot_color['opt'], linewidth=line_width, label='opt.')
ax1.plot(time_array[0:6], em_ave_error_array[0:6], '-x', color = plot_color['em'], linewidth=line_width, label='EM')
ax1.plot(time_array[0:6], boem_ave_error_array[0:6], '-x', color = plot_color['boem'], linewidth=line_width, label='BOEM')
...
ax2.plot(time_array[0:6], opt_process_time_array[0:6], '-x', color = plot_color['opt'], linewidth=line_width, label='opt.')
ax2.plot(time_array[0:6], em_process_time_array[0:6], '-x', color = plot_color['em'], linewidth=line_width, label='EM')
ax2.plot(time_array[0:6], boem_process_time_array[0:6], '-x', color = plot_color['boem'], linewidth=line_width, label='BOEM')
